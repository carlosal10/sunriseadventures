...
export default function TourDetails({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="space-y-16">
      <section className="relative min-h-[620px] overflow-hidden rounded-[2.5rem] border border-white/60 shadow-[0_30px_90px_rgba(63,41,22,0.18)] h-[74vh]">
        ...
        <section>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {tour.testimonials.map((testimonial, index) => (
              <blockquote key={`${testimonial.name ?? 'traveler'}-${index}`} className="premium-card p-7">
